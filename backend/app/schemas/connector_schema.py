...
Top-level extra fields are forbidden, so this is CloudEvents-inspired rather
than full CloudEvents 1.0 (which allows extension attributes). PrivacyTrace
fields live in `data` with extra=forbid. No CloudEvents library.
"""
